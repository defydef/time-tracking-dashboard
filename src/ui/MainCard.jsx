...
function MainCard({ period, setPeriod }) {
  return (
    <div className="bg-[var(--card-bg)] w-[20.4375rem] sm:w-[15.9375rem] rounded-[0.9375rem] pb-3 flex flex-col gap-3 sm:row-span-full">
      <section className="bg-[var(--primary)] rounded-[0.9375rem] px-5 py-6 sm:px-10 sm:py-11 sm:h-[22.125rem]">
        <div className="flex sm:flex-col items-center sm:items-start justify-start gap-5 sm:gap-12">
      ...
      <section className="flex sm:flex-col justify-around items-end sm:items-start sm:gap-3 sm:py-3 sm:px-10 text-[var(--secondary-heading)]">
        <TimePeriod
          onSelect={setPeriod}
          label="Daily"
