function ActivityCard() {
  return (
    <div className="bg-[var(--work)] w-[20.4375rem] rounded-[0.9375rem] flex flex-col gap-3 justify-end overflow-hidden">
      <div className="flex justify-end mt-[-0.75rem] ">
      ...
      <section className="bg-[var(--card-bg)] rounded-[0.9375rem] px-5 py-6">
